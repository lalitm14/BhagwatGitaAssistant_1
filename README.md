...
- **Talking Avatar**: Generates a video of a talking head (SadTalker) synchronised with the audio **(!!) Take note in current App version released here SadTalker talking-head feature is not implemented**.
